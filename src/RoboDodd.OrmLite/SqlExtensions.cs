    ...
    public static class SqlExtensions
    {
        ...
        public static string? GetSqlOrderBy(this object obj, List<TableAlias> names, string propertyName = "OrderBy")
        {
            ...
            for (var index = 0; index < orders.Length; index++)
            {
                ...
                {
                    orderItem = orderCommand[0];  // Field name comes first
                    cond = orderCommand[1];       // Direction comes second
                }
        ...
        public static bool IsNullEmptyOrWhiteSpace([NotNullWhen(false)] this string? value)
        {
            if (value == null)
                return true;
